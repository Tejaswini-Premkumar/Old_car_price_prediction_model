...
st.title("Used car price predicion")

brand = st.selectbox(
    "Brand",
    ("Audi",'BMW','Bently','Chevrolet','Datsun','Fiat','Force','Ford',
     'Honda','Hyundai','Isuzu','Jaguar','Jeep','Kia','Land','Lexus',
     'MG','Mahindra','Maruti','Maserati','Mercedes-Benz','Mini',
